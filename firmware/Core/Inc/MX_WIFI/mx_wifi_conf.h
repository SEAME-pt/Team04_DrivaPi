...
/*
 * Board compatibility aliases: ST Wi-Fi middleware expects MXCHIP_* labels,
 * while this CubeMX project uses WRLS_* GPIO labels.
 */
#ifndef MXCHIP_NSS_Pin
#define MXCHIP_NSS_Pin                            WRLS_SPI2_NSS_Pin
#endif

#ifndef MXCHIP_NSS_GPIO_Port
#define MXCHIP_NSS_GPIO_Port                      WRLS_SPI2_NSS_GPIO_Port
#endif

#ifndef MXCHIP_NOTIFY_Pin
#define MXCHIP_NOTIFY_Pin                         WRLS_NOTIFY_Pin
#endif

#ifndef MXCHIP_NOTIFY_GPIO_Port
#define MXCHIP_NOTIFY_GPIO_Port                   WRLS_NOTIFY_GPIO_Port
#endif

#ifndef MXCHIP_FLOW_Pin
#define MXCHIP_FLOW_Pin                           WRLS_FLOW_Pin
#endif

#ifndef MXCHIP_FLOW_GPIO_Port
#define MXCHIP_FLOW_GPIO_Port                     WRLS_FLOW_GPIO_Port
#endif

#ifndef MXCHIP_RESET_Pin
#define MXCHIP_RESET_Pin                          WRLS_WKUP_W_Pin
#endif

#ifndef MXCHIP_RESET_GPIO_Port
...
#ifndef MXCHIP_NOTIFY_EXTI_IRQn
...
#else
#include <MX_WIFI/mx_wifi_bare_os.h>
#endif /* MX_WIFI_USE_CMSIS_OS */
...
#define MX_WIFI_CMD_TIMEOUT                         (1000)  /* default 10s timeout */
