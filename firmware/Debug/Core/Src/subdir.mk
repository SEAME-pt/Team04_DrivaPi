...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/app_threadx.d ./Core/Src/app_threadx.o ./Core/Src/app_threadx.su ./Core/Src/can_rx.d ./Core/Src/can_rx.o ./Core/Src/can_rx.su ./Core/Src/can_tx.d ./Core/Src/can_tx.o ./Core/Src/can_tx.su ./Core/Src/dc_motor.d ./Core/Src/dc_motor.o ./Core/Src/dc_motor.su ./Core/Src/init_devices.d ./Core/Src/init_devices.o ./Core/Src/init_devices.su ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/motor_control.d ./Core/Src/motor_control.o ./Core/Src/motor_control.su ./Core/Src/motor_utils.d ./Core/Src/motor_utils.o ./Core/Src/motor_utils.su ./Core/Src/sensors.d ./Core/Src/sensors.o ./Core/Src/sensors.su ./Core/Src/servo_motor.d ./Core/Src/servo_motor.o ./Core/Src/servo_motor.su ./Core/Src/speed_sensor.d ./Core/Src/speed_sensor.o ./Core/Src/speed_sensor.su ./Core/Src/stm32u5xx_hal_msp.d ./Core/Src/stm32u5xx_hal_msp.o ./Core/Src/stm32u5xx_hal_msp.su ./Core/Src/stm32u5xx_it.d ./Core/Src/stm32u5xx_it.o ./Core/Src/stm32u5xx_it.su ./Core/Src/supervisor.d ./Core/Src/supervisor.o ./Core/Src/supervisor.su ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32u5xx.d ./Core/Src/system_stm32u5xx.o ./Core/Src/system_stm32u5xx.su ./Core/Src/systemview_threadx_hooks.d ./Core/Src/systemview_threadx_hooks.o ./Core/Src/systemview_threadx_hooks.su ./Core/Src/thread_init.d ./Core/Src/thread_init.o ./Core/Src/thread_init.su Core/Src/tx_initialize_low_level.d Core/Src/tx_initialize_low_level.o ./Core/Src/ultrasonic.d ./Core/Src/ultrasonic.o ./Core/Src/ultrasonic.su
