            ...
            ColumnLayout {
                ...
                ComponentCard {
                    ...
                    metrics: [
                        {
                            label: "CPU Temp",
                            value: (systemStatus.cpuUsage || 0) + "°C",
                            warning: (systemStatus.cpuUsage || 0) > 70
                        },
                        {
                            label: "CPU Usage",
                            value: (systemStatus.cpuUsage || 0) + "%",
                            warning: (systemStatus.cpuUsage || 0) > 80
                        },
                        {
                            label: "Memory",
                            value: (systemStatus.memoryUsage || 0) + "%",
                            warning: (systemStatus.memoryUsage || 0) > 85
                        },
                        {
                            label: "Voltage",
                            value: "5.1 V",
                ...
                ComponentCard {
                    ...
                    metrics: [
                        ...
                        {
                            label: "Position",
                            value: (vehicleData.gear || "N") === "D" ? "Center" : "Neutral",
                            warning: false
                        },
                        {
                            label: "Throttle",
                        ...
                        {
                            label: "Position",
                            value: (vehicleData.speed || 0) > 0 ? Math.round((vehicleData.speed || 0) / 2) + "%" : "0%",
                            warning: false
                        },
                        {
                            label: "Response",
                ...
                ComponentCard {
                    ...
                    metrics: [
                        ...
                        {
                            label: "Battery Mon.",
                            value: (vehicleData.battery || 0) + "%",
                            warning: (vehicleData.battery || 0) < 20
                        },
                        {
                            label: "Temperature",
                            value: (vehicleData.temperature || 0) + "°C",
                            warning: (vehicleData.temperature || 0) > 80
                        }
                    ]
                }
                ...
                ComponentCard {
                    ...
                    metrics: [
                        ...
                        {
                            label: "KUKSA",
                            value: systemStatus.connectionState || "unknown",
                            warning: (systemStatus.connectionState || "disconnected") !== "connected"
                        },
                        {
                            label: "Latency",
                            value: ((systemStatus.latency || 0).toFixed(0)) + " ms",
                            warning: (systemStatus.latency || 0) > 100
                        },
                        {
                            label: "Frame Rate",
                            value: (systemStatus.frameRate || 0) + " Hz",
                            warning: (systemStatus.frameRate || 0) < 10
                        }
                    ]
                }
                ...
                ComponentCard {
                    ...
                    metrics: [
                        {
                            label: "Status",
                            value: systemStatus.gpsStatus || "Seeking",
                            warning: false
                        },
                        {
                            label: "Satellites",
                ...
                ComponentCard {
                    ...
                    metrics: [
                        ...
                        },
                        {
                            label: "Temp",
                            value: (vehicleData.temperature || 0) + "°C",
                            warning: (vehicleData.temperature || 0) > 70
                        },
                        {
                            label: "Cycles",
                            value: "412",
                ...
                ComponentCard {
                    ...
                    metrics: [
                        ...
                        {
                            label: "Available",
                            value: (100 - (systemStatus.memoryUsage || 0)) + "%",
                            warning: false
                        },
                        {
                            label: "Buffers",
